...
#ifndef ACTIVE_SETTING_UINT32_VALUE
...
namespace active::setting {
	...
	*/
	template<> inline
	Value& UInt32Value::operator=(bool val) {
		data = val ? 1 : 0;
		return *this;
	}
	/*!
	...
	*/
	template<> inline
	Value& UInt32Value::operator=(int32_t val) {
	...
	*/
	template<> inline
	Value& UInt32Value::operator=(uint32_t val) {
		data = val;
		return *this;
	}
	/*!
	...
	*/
	template<> inline
	Value& UInt32Value::operator=(int64_t val) {
		data = static_cast<uint32_t>(val);
		return *this;
	}
	/*!
	...
	*/
	template<> inline
	Value& UInt32Value::operator=(double val) {
		data = static_cast<uint32_t>(math::round(val, 1.0));
		return *this;
	}
	/*!
		Assignment operator
	...
	*/
	template<> inline
	UInt32Value::operator bool() const { return (data != 0); }
	/*!
		Get a 32-bit integer value
		@return A 32-bit integer value
	*/
	template<> inline
	UInt32Value::operator int32_t() const { return static_cast<uint32_t>(data); }
	/*!
		Get an unsigned 32-bit integer value
		@return An unsigned 32-bit integer value
	*/
	template<> inline
	UInt32Value::operator uint32_t() const { return data; }
	/*!
		Get a 64-bit integer value
		@return A 64-bit integer value
	*/
	template<> inline
	UInt32Value::operator int64_t() const 	{ return data; }
	/*!
		Get a double precision value
		@return A double precision value
	*/
	template<> inline
	UInt32Value::operator double() const { return data; }
	/*!
		Get a string value
	...
	*/
	template<> inline
	bool UInt32Value::isNull() const { return (data != 0); }
	/*!
		Get the value type
		@return The value type
	*/
	template<> inline
	Value::Type UInt32Value::getType() const { return intType; };
	
}

#endif	//ACTIVE_SETTING_UINT32_VALUE

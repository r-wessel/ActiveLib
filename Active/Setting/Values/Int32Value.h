...
namespace active::setting {
	...
	*/
	template<> inline
	Value& Int32Value::operator=(const Time& val) {
	...
	*/
	template<> inline
	Int32Value::operator String() const 	{ return String{data}; }
	/*!
		Get a time value
		@return A time value
	*/
	template<> inline
	Int32Value::operator Time() const { return Time{static_cast<int64_t>(data)}; }

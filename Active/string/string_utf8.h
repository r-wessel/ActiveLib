	...
	*/
	...
	public:
		...
		static std::optional<basic_string> from_unicode(const char32_t*& text, bool is_big_endian,
													   std::optional<size_type> howMany = std::nullopt, bool isCountRequired = false);
		/*!
		 ...
		 */
		size_type make_string(base& target, const char* text, std::optional<size_type> howMany = std::nullopt,
							 std::optional<size_type> charCount = std::nullopt, text_format format = text_format{});
		/*!
		...
		*/
		basic_string(const char* source, std::optional<size_type> howMany = std::nullopt, text_format format = text_format{});
#ifndef __CLR_VER
		/*!
		...
		*/
		basic_string(const char8_t* source, std::optional<size_type> howMany = std::nullopt) : basic_string{reinterpret_cast<const char*>(source), howMany, text_format{}} {}
#endif // !__CLR_VER
		/*!
		...
		*/
		basic_string(const char16_t* source, std::optional<size_type> howMany = std::nullopt, bool is_big_endian = text_format::defaultEndian) : basic_string{reinterpret_cast<const char*>(source),
				howMany ? std::optional<size_type>(*howMany * sizeof(char16_t)) : std::nullopt, text_format{UTF16, is_big_endian}} {}
		/*!
			Constructor from an input UTF32 char array
			@param source The character array to be copied
			@param howMany The number of 32-bit chars to copy (nullopt for null-terminated)
		*/
		basic_string(const char32_t* source, std::optional<size_type> howMany = std::nullopt, bool is_big_endian = text_format::defaultEndian) : basic_string{reinterpret_cast<const char*>(source),
				howMany ? std::optional<size_type>(*howMany * sizeof(char32_t)) : std::nullopt, text_format{UTF32, is_big_endian}} {}
		/*!
			...
			@param format The source text data format
		*/
		basic_string(const base& source, std::optional<size_type> howMany = std::nullopt, text_format format = text_format{}) :
		...
		/*!
			...
			@param howMany The number of chars to copy (nullopt for full length)
		*/
		basic_string(const std::u8string& source, std::optional<size_type> howMany = std::nullopt) : basic_string(source.data(), howMany) {}
#endif // !__CLR_VER
		/*!
			Constructor from an input string
			...
			@param howMany The number of chars to copy (nullopt for full length)
		*/
		basic_string(const std::u16string& source, std::optional<size_type> howMany = std::nullopt);
		/*!
			Constructor from an input string
			@param source The UTF-32 string to be copied
			@param howMany The number of chars to copy (nullopt for full length)
		*/
		basic_string(const std::u32string& source, std::optional<size_type> howMany = std::nullopt);
		/*!
		...
		*/
		...
		/*!
			Constructor from std::string::size_type integer
			@param val A std::string::size_type integer
		*/
		explicit basic_string(std::string::size_type val) { m_string = std::to_string(static_cast<uint64_t>(val)); }
		...
		*/
		std::string::size_type dataSize(std::optional<size_type> howMany = std::nullopt) const;
		/*!
		...
		*/
		basic_string substr(size_type startPos = 0, std::optional<size_type> howMany = std::nullopt) const;
		/*!
		...
		*/
		bool isAlphaNumeric(size_type startPos = 0, std::optional<size_type> howMany = std::nullopt) const;
		/*!
		...
		*/
		bool isAlpha(size_type startPos = 0, std::optional<size_type> howMany = std::nullopt) const;
		/*!
		...
		*/
		bool isNumeric(size_type startPos = 0, std::optional<size_type> howMany = std::nullopt) const;
		/*!
		...
		*/
		std::optional<size_type> find(const basic_string& toFind, size_type startPos = 0) const;
		/*!
			Find the specified string within this using a filter
			@param filter The string filter
			@return The index where a match is found (nullopt = not found)
		*/
		std::optional<size_type> findIf(const Filter& filter) const;
		/*!
		...
		*/
		std::optional<size_type> findFirstOf(const basic_string& toFind, size_type startPos = 0) const;
		/*!
		...
		*/
		std::optional<size_type> findFirstNotOf(const basic_string& toFind, size_type startPos = 0) const;
		/*!
		...
		*/
		std::optional<size_type> findLastOf(const basic_string& toFind, std::optional<size_type> lastPos = std::nullopt) const;
		/*!
		...
		*/
		std::optional<size_type> findLastNotOf(const basic_string& toFind, std::optional<size_type> lastPos = std::nullopt) const;
		/*!
		...
		*/
		std::optional<size_type> rfind(const basic_string& toFind, std::optional<size_type> lastPos = std::nullopt) const;
		...
		*/
		size_type assign(const char* source, std::optional<size_type> byteCount = std::nullopt, std::optional<size_type> charCount = std::nullopt, text_format format = text_format{});
		/*!
		...
		*/
		...
		/*!
			...
			@return A reference to this
		*/
		basic_string& insert(size_type pos, const basic_string& source, size_type start = 0, std::optional<size_type> howMany = std::nullopt);
		/*!
			...
			@return A reference to this
		*/
		basic_string& replace(std::optional<size_type> pos, std::optional<size_type> num, const basic_string& source, size_type start = 0, std::optional<size_type> howMany = std::nullopt);
		/*!
		...
		*/
		...
		/*!
			...
			@return A reference to this
		*/
		basic_string& erase(size_type pos = 0, std::optional<size_type> howMany = std::nullopt);
		/*!
...
namespace active::string_function {
	 ...
	 */
	std::string::size_type getValidByteCount(const char* text, std::optional<std::string::size_type> howMany = std::nullopt, std::optional<std::string::size_type> charCount = std::nullopt, text_format format = text_format{});
	/*!
	 ...
	 */
	std::optional<unsigned char> getCharacterByteCount(const char* text, std::optional<std::string::size_type> howMany = std::nullopt,
	 ...
	 */
	std::optional<std::string::size_type> getByteCountCharLimited(const char* text, std::optional<std::string::size_type> howMany = std::nullopt, bool isCountRequired = false,
																  text_format format = text_format{});
	/*!
	 ...
	 */
	std::optional<std::string::size_type> getCharacterCount(const char* text, std::optional<std::string::size_type> howMany = std::nullopt, text_format format = text_format{});
	/*!
	 ...
	 */
	std::optional<std::string::size_type> getCharCount(unsigned char wordSize, std::optional<std::string::size_type> howMany = std::nullopt, std::optional<std::string::size_type> charCount = std::nullopt);
	/*!
	 ...
	 */
	std::string::size_type getStringLength(const char* text, std::optional<std::string::size_type> howMany = std::nullopt, text_format format = text_format{});
	/*!
	 ...
	 */
	std::pair<char32_t, unsigned char> getUTF32CharFromUTF8(const char*& text, std::string::size_type howMany);
	/*!
	 ...
	 @return A UTF-32 char paired with the number of bytes consumed from the source (0 = no valid char found)
	 */
	std::pair<char32_t, unsigned char> getUTF32CharFromUTF16(const char16_t*& text, bool is_big_endian, std::string::size_type howMany);
	/*!
	 ...
	 */
	std::pair<char32_t, unsigned char> getUnicodeChar(const char* text, std::optional<std::string::size_type> howMany = std::nullopt, text_format format = text_format{});
	/*!
	 ...
	 */
	std::optional<std::u32string> toUnicode(const char*& text, std::optional<std::string::size_type> howMany = std::nullopt, bool isCountRequired = false);
	/*!
	 ...
	 */
	std::optional<std::u32string> fromUTF16(const char16_t*& text, bool is_big_endian, std::optional<std::string::size_type> howMany = std::nullopt, bool isCountRequired = false);
	/*!
	 ...
	 */
	std::optional<std::u16string> toUTF16(const char32_t*& text, std::optional<std::string::size_type> howMany = std::nullopt, bool isCountRequired = false);
	/*!
	 ...
	 */
	std::vector<unsigned char> collectCharByteCount(const char* text, std::optional<std::string::size_type> howMany = std::nullopt,
													text_format format = text_format{});
	/*!
	 ...
	 */
	std::optional<std::pair<std::string::size_type, std::string::size_type>> getByteOffsets(const char* text,
																							std::string::size_type startPos = 0, std::optional<std::string::size_type> howMany = std::nullopt, bool isHowManyChars = false);
...
namespace active {
	...
	*/
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>::basic_string(const char* source, std::optional<size_type> howMany, text_format format) {
		 make_string(m_string, source, howMany, std::nullopt, format);
	...
	/*--------------------------------------------------------------------
	 ...
	 --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>::basic_string(const std::u16string& source, std::optional<size_type> howMany) {
	...
	/*--------------------------------------------------------------------
	 ...
	 --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>::basic_string(const std::u32string& source, std::optional<size_type> howMany) {
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<basic_string<Alloc>> basic_string<Alloc>::from_unicode(const char32_t*& text, bool is_big_endian, std::optional<size_type> howMany, bool isCountRequired) {
		if (howMany == 0)
			return std::optional(basic_string{});	//An empty string is not an error, so we don't return std::nullopt
		basic_string result;
		for ( ; *text != 0; ++text) {
			if (howMany) {
				if (howMany == 0)
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>::size_type basic_string<Alloc>::make_string(base& target, const char* text, std::optional<size_type> howMany,
								 std::optional<size_type> charCount, text_format format) {
		target.clear();
		if (text == nullptr)
			return 0;
		...
		switch (format.encoding) {
			...
			case UTF16: {
				...
				if (auto string32 = string_function::fromUTF16(source, format.is_big_endian, string_function::getCharCount(sizeof(char16_t), howMany, charCount)); string32) {
			...
			case UTF32: {
				...
				if (auto uniString = from_unicode(source, format.is_big_endian, string_function::getCharCount(sizeof(char32_t), howMany, charCount)); uniString) {
					target = *uniString;
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::string::size_type basic_string<Alloc>::dataSize(std::optional<size_type> howMany) const {
		if (!howMany)
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc> basic_string<Alloc>::substr(size_type startPos, std::optional<size_type> howMany) const {
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	bool basic_string<Alloc>::isAlphaNumeric(size_type startPos, std::optional<size_type> howMany) const {
#ifdef WINDOWS
		std::u16string uniString{*this};
#else
		std::u32string uniString{*this};
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	bool basic_string<Alloc>::isAlpha(size_type startPos, std::optional<size_type> howMany) const {
#ifdef WINDOWS
		std::u16string uniString{*this};
#else
		std::u32string uniString{*this};
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	bool basic_string<Alloc>::isNumeric(size_type startPos, std::optional<size_type> howMany) const {
#ifdef WINDOWS
		std::u16string uniString{*this};
#else
		std::u32string uniString{*this};
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::find(const basic_string& toFind, size_type startPos) const {
		auto startByte = (startPos == 0) ? 0 : string_function::getByteCountCharLimited(m_string.data(), startPos, true);
		if (!startByte)
			return std::nullopt;
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::findIf(const Filter& filter) const {
		auto remaining = dataSize();
		auto text = data();
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::findFirstOf(const basic_string& toFind, size_type startPos) const {
		...
		return (firstPos == npos) ? std::nullopt : string_function::getCharacterCount(data(), firstPos);
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::findFirstNotOf(const basic_string& toFind, size_type startPos) const {
		auto splitString = split_single_chars(toFind);
		if (splitString.empty())
			return std::nullopt;
		...
		return startPos < length() ? std::optional<size_type>(startPos) : std::nullopt;
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::findLastOf(const basic_string& toFind, std::optional<size_type> lastPos) const {
		auto splitString = split_single_chars(toFind);
		if (splitString.empty())
			return std::nullopt;
		auto firstPos = npos;
		auto startByte = (lastPos == npos) ? npos : string_function::getByteCountCharLimited(m_string.data(), lastPos, false);
		bool isFirst = true;
		for (auto& iter : splitString) {
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::findLastNotOf(const basic_string& toFind, std::optional<size_type> lastPos) const {
		...
		for (auto iter = charBytes.rbegin(); iter != charBytes.rend(); ++iter, --(*lastPos)) {
			...
			if (*iter == 1) {
				...
				std::optional<size_type> highest;
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	std::optional<typename basic_string<Alloc>::size_type> basic_string<Alloc>::rfind(const basic_string& toFind, std::optional<size_type> lastPos) const {
		...
		return (foundPos == npos) ? std::nullopt : string_function::getCharacterCount(data(), foundPos);
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>::size_type basic_string<Alloc>::assign(const char* source, std::optional<size_type> byteCount, std::optional<size_type> charCount, text_format format) {
		m_string.clear();
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>& basic_string<Alloc>::insert(size_type pos, const basic_string& source, size_type start, std::optional<size_type> howMany) {
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>& basic_string<Alloc>::replace(std::optional<size_type> pos, std::optional<size_type> num, const basic_string& source, size_type start, std::optional<size_type> howMany) {
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	template <class Alloc>
	basic_string<Alloc>& basic_string<Alloc>::erase(size_type pos, std::optional<size_type> howMany) {
